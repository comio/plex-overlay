...
PATCHES=(
	...
	"${FILESDIR}/20200129_add_gentoo_profile_as_platform_version.patch"
)
...
src_install() {
	...
	local UNIT_NAME="${PN}.service"
	local UNIT="${S}/usr/lib/plexmediaserver/lib/plexmediaserver.service"
	systemd_newunit "${UNIT}" "${UNIT_NAME}"
